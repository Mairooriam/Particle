...
enum { LOG_TRACE, LOG_DEBUG, LOG_INFO, LOG_WARN, LOG_ERROR, LOG_FATAL, LOG_ALLOC, LOG_DE_ALLOC };

#define log_alloc(...) log_log(LOG_ALLOC, __FILE__, __LINE__, __func__, __VA_ARGS__)
#define log_de_alloc(...) log_log(LOG_DE_ALLOC, __FILE__, __LINE__, __func__, __VA_ARGS__)
